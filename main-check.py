...
def check_http_status(cleaned_uri):
    try:
        curl_command = f"curl -I http://c0a21099-ja-0701.a910.tak-cslab.org{cleaned_uri} | head -n 1 | cut -d' ' -f2"
...
def main():
    ...
    try:
        ...
        create_and_insert_table(cursor, 
                                ...
                                """INSERT INTO wp_nissy_posts (post_title, post_name, guid, post_status, post_type, post_date)
                                    SELECT post_title, post_name, guid, post_status, post_type, post_modified AS post_date
                                    FROM wp_posts
        ...
        create_and_insert_table(cursor,
                                """INSERT INTO wp_nissy_kekka (cleaned_uri, post_title, post_name, guid, post_status, post_type, total_count, post_date)
                                    SELECT DISTINCT
                                        cleaned_uri,
                                        post_title, 
                                        post_name, 
        ...
        create_and_insert_table(cursor,
                                ...
                                """INSERT INTO wp_nissy_kekka_new (cleaned_uri, post_title, post_name, guid, post_status, post_type, total_count, post_date)
                                    SELECT DISTINCT
                                        cleaned_uri,
                                        post_title, 
                                        post_name, 
        ...
        cursor.execute("SELECT id, cleaned_uri, total_count, post_title, post_name, guid, post_status, post_type, post_date FROM wp_nissy_kekka_new;")
        ...
        # ファイルにデータを書き込む
        output_file_path = 'main-check-output.txt'
        try:
